...
public class LibrarianLogin extends JFrame {
	protected static final LibrarianLogin LibrarianSuccess = null;
	protected static final String LibrarianDao = null;
	...
	public LibrarianLogin() {
		...
		btnLogin.addActionListener(new ActionListener() {
			...
			if(name.equals("Librarian_01","Librarian_02","Librarian_03")&&password.equals("LibrarianOne","LibrarianTwo","LibrarianThree")){
		        ...
		        JOptionPane.showMessageDialog(null, "SUCCESFULLY", "Librarian Success", 1);
		        textField.setText("");
